  ...
  return (
    <Stack>
            ...
            <Grid item xl={6}>
              <FormControl fullWidth>
                <FormGroup sx={{ marginTop: "1rem" }}>
                  ...
                  >
                    <MenuItem value="Buxoro Viloyati">Buxoro Viloyati</MenuItem>
                    <MenuItem value="Toshkent Viloyati">
                      Toshkent Viloyati
                    </MenuItem>
                    <MenuItem value="Toshkent Shahri">Toshkent Shahri</MenuItem>
                  </TextField>
                </FormGroup>
                <FormGroup sx={{ marginTop: "2rem" }}>
                  ...
                  >
                    <MenuItem value="Buxoro Shaxar">Buxoro Shaxar</MenuItem>
            ...
            <CardContent>
              <Box>
                <Fab
                  ...
                  aria-label="Region"
                >
                  <TagIcon sx={{ mr: 1 }} color="success" fontSize="small" />
                  {region}
                </Fab>
                <Fab
                  sx={{
      ...
      <Grid container>
        <Grid xl={8}>
          <Typography mb={3} color="primary" variant="h6">
            Enter location for Advertising
          </Typography>
          <SimpleMap />
        </Grid>
      </Grid>
      <Grid mt={3} container spacing={2}>
        <Grid item xl={4}>
          ...
          <Stack mt={2}>
            ...
            <Grid mt={3}  
                ...
                onChange={onFileDrop}/>
                Upload</Button>
              <Button variant="outlined" sx={{margin:'5px', backgroundColor:'none'}}>
                <DropFilePreviewItemDel  onClick={() => fileRemove(0)}>
              ...
              <Box mt={3}>
                ...
                {fileList.map((item, index) => (
                  <DropFilePreviewItem key={index}>
                    ...
                    {/* <DropFilePreviewItemDel onClick={() => fileRemove(item)}>
                      <ClearIcon />
                    </DropFilePreviewItemDel> */}
                  </DropFilePreviewItem>
                ))}
        ...
        <Grid item xl={8}>
          <Typography color="primary" mb={2} variant="h6">
            Enter description for Advertising
          </Typography>
          <ReactQuill
